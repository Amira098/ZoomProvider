...
class _AuthRetrofitClient implements AuthRetrofitClient {
  ...
  @override
  Future<SendResetEmail> sendResetEmail(String email) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'email': email};
    final _options = _setStreamType<SendResetEmail>(
      Options(
        method: 'POST',
        headers: _headers,
        extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SendResetEmail _value;
    try {
      _value = SendResetEmail.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<ResetPasswordModel> resetPassword(
    ...
    final _options = _setStreamType<ResetPasswordModel>(
      Options(
        method: 'POST',
        headers: _headers,
        extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ResetPasswordModel _value;
    try {
      _value = ResetPasswordModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
