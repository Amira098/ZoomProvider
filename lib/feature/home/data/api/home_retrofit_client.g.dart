...
class _HomeRetrofitClient implements HomeRetrofitClient {
  ...
  Future<CompletedPaidModel> completedPaid(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = body;
    final _options = _setStreamType<CompletedPaidModel>(
      Options(
        method: 'POST',
        headers: _headers,
        extra: _extra,
        contentType: 'application/x-www-form-urlencoded',
          ...
          .compose(
            _dio.options,
            'orders/${orderId}}/request-new-payment',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CompletedPaidModel _value;
    try {
      _value = CompletedPaidModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<SuspendWithGoodsReturnedModel> suspendWithGoodsReturned(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = body;
    final _options = _setStreamType<SuspendWithGoodsReturnedModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'orders/${orderId}/suspend-with-goods-returned',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SuspendWithGoodsReturnedModel _value;
    try {
      _value = SuspendWithGoodsReturnedModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<ProductsInOrders> productsInOrders(int orderId, String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ProductsInOrders>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProductsInOrders _value;
    try {
      _value = ProductsInOrders.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<GetReceivedRequestsModel> getReceivedRequests(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetReceivedRequestsModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'recived-requests',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetReceivedRequestsModel _value;
    try {
      _value = GetReceivedRequestsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<CreatePatientModel> createPatient(
    ...
    final _options = _setStreamType<CreatePatientModel>(
      Options(
        method: 'POST',
        headers: _headers,
        extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CreatePatientModel _value;
    try {
      _value = CreatePatientModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<CreateReservationModel> createReservation(
    ...
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    final _data = {'patient_id': patientId, 'date': date, 'time': time};
    final _options = _setStreamType<CreateReservationModel>(
      Options(
        method: 'POST',
        headers: _headers,
        extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CreateReservationModel _value;
    try {
      _value = CreateReservationModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
