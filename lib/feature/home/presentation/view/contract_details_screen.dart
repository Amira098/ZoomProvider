                  ...
                  SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _bulletItem(LocaleKeys.Home_complete_water_system_inspection.tr()),
                        _bulletItem(LocaleKeys.Home_primary_filter_candle_replacement.tr()),
                        _bulletItem(LocaleKeys.Home_pressure_tank_check.tr()),
                        _bulletItem(LocaleKeys.Home_tds_level_testing.tr()),
                        _bulletItem(LocaleKeys.Home_leakage_detection_check.tr()),
                        _bulletItem(LocaleKeys.Home_two_scheduled_visits_per_year.tr()),
                        _bulletItem(LocaleKeys.Home_priority_emergency_support.tr()),
                      ],
                    ),
                  ),
                  Positioned(
